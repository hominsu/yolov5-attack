...
struct Rect {
 ...
 public:
  ...
  [[nodiscard]] inline cv::Point getPointTopLeft() const {
    return {x_, y_};
  }

  [[nodiscard]] inline cv::Point getPointTopRight() const {
    return {x_ + width_, y_};
  }

  [[nodiscard]] inline cv::Point getPointBottomLeft() const {
    return {x_, y_ + height_};
  }

  [[nodiscard]] inline cv::Point getPointBottomRight() const {
